...
public class Ejercicio6 extends javax.swing.JFrame {
   ...
   private int tam; // usa un nombre claro
    ...
    new Object[]{"Nombre", "Ventas Totales"}, 
    0
);
jTable1.setModel(modeloTabla);
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Ingrese un total de ventas");
        ...
        jPaggempleadoLayout.setHorizontalGroup(
            ...
            .addGroup(jPaggempleadoLayout.createSequentialGroup()
                .addGroup(jPaggempleadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPaggempleadoLayout.createSequentialGroup()
                        .addGap(20, 20, 20)
                        .addGroup(jPaggempleadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int pos = LogicaVendedores.Busca(Nombre, nombreBuscado, n);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if(nombreNuevo5.getText().isEmpty() ||nombreNuevo8.getText().isEmpty()){
                ...
                int totalventas = Integer.parseInt(nombreNuevo8.getText());
                

                // llamada a logicaVendedores
                n = LogicaVendedores.InsertaO(Nombre, ventasT,
                    n, tam, nuevoNombre, totalventas);
            ...
            JOptionPane.showMessageDialog(this, "El total de ventas debe ser un número entero.");
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            float nuevoVT = Float.parseFloat(añosanti.getText());
            boolean modificado = LogicaVendedores.ModificaO(Nombre, ventasT, n, jTextField2.getText(), nuevoVT);
